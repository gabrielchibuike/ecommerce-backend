...
import { cookieConfig, shortLivedCookieConfig } from "../utils/cookies";
...
export async function loginController(req: Request, res: Response) {
  try {
    ...
    res.cookie("accessToken", accessToken, shortLivedCookieConfig);
    ...
    //     httpOnly: true,
    //     secure: process.env.NODE_ENV === "produrefreshTokenction",
    //     sameSite: "strict",
